    ...
    <div class="grid grid-cols-1 md:grid-cols-2">
        <div class="p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4 text-lg leading-7 font-semibold">
                    <a href="{{url('/prime-numbers')}}" class="underline text-gray-900 dark:text-white">Prime Numbers</a>
                </div>
            </div>
        ...
        <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l">
            <div class="flex items-center">
                ...
                <div class="ml-4 text-lg leading-7 font-semibold">
                    <a href="{{url('/ascii-array')}}" class="underline text-gray-900 dark:text-white">ASCII Array</a>
                </div>
            </div>
        ...
        <div class="p-6 border-t border-gray-200 dark:border-gray-700">
            <div class="flex items-center">
                ...
                <div class="ml-4 text-lg leading-7 font-semibold">
                    <a href="{{url('/tv-series')}}" class="underline text-gray-900 dark:text-white">TV Series</a>
                </div>
            </div>
        ...
        <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-l">
            <div class="flex items-center">
                ...
                <div class="ml-4 text-lg leading-7 font-semibold">
                    <a href="{{url('/ab-testing')}}" class="underline text-gray-900 dark:text-white">A/B Testing</a>
                </div>
            </div>
